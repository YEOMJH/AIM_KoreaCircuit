...
public class ModifyChangeRunControl extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ModifyChangeRunControl", getEventUser(), getEventComment(), "", "");
		...
		for (Element control : controlList)
		{
			...
			ChangeRunControl dataInfo = ExtendedObjectProxy.getChangeRunControlService().selectByKey(false, new Object[] { machineName, processOperationName, processOperationVersion });
			...
			dataInfo = ExtendedObjectProxy.getChangeRunControlService().modify(eventInfo, dataInfo);
		}
