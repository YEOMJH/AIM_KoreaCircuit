...
public class DeleteDSPRunControl extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("DeleteDSPRunControl", getEventUser(), getEventComment(), "", "");
		...
		for (Element control : controlList)
		{
			...
			ExtendedObjectProxy.getDSPRunControlService().deleteDSPRunControlData(eventInfo, machineName, processOperationName, processOperationVersion);
		}
