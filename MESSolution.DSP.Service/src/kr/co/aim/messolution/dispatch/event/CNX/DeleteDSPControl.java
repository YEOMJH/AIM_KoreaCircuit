...
public class DeleteDSPControl extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("DeleteDSPControl", getEventUser(), getEventComment(), "", "");
		...
		for (Element control : controlList)
		{
			...
			ExtendedObjectProxy.getDSPControlService().deleteDSPControlData(eventInfo, machineName, processOperationName, processOperationVersion);
		}
