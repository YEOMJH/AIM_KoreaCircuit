...
public class PortStateChanged extends AsyncHandler {
	...
	public void doWorks(Document doc) throws CustomException
	{
		...
		if (StringUtils.equals(portStateName, GenericServiceProxy.getConstantMap().Port_EMPTY) || StringUtils.equals(portStateName, GenericServiceProxy.getConstantMap().Port_FULL))
		{
			newPortStateName = GenericServiceProxy.getConstantMap().Port_UP;
		}
		else
		{
			newPortStateName = portStateName;
		}
		
		MakePortStateByStateInfo transitionInfo = MESPortServiceProxy.getPortInfoUtil().makePortStateByStateInfo(portData, newPortStateName);
