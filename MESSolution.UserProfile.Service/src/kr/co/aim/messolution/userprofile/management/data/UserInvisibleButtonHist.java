...
public class UserInvisibleButtonHist extends UdfAccessor implements DataInfo<UserInvisibleButtonHistKey> 
{
	private UserInvisibleButtonHistKey key;
	...
	public UserInvisibleButtonHistKey getKey()
	{
		return key;
	}
	public void setKey(UserInvisibleButtonHistKey key)
	{
		this.key = key;
	}
