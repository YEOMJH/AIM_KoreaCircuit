...
public class TransportJobServiceImpl implements ApplicationContextAware{
			...
			String completeQuantity) throws CustomException
	{
		List<Map<String, Object>> reserveProductSpecInfo = 
			MESTransportServiceProxy.getTransportJobServiceUtil().getReserveProductSpecData(
		...
		String sql = "UPDATE CT_RESERVEPRODUCT SET " +
				 ...
				 " RESERVEDQUANTITY = :reservedQuantity, COMPLETEQUANTITY = :completeQuantity , LASTEVENTNAME = :lastEventName, LASTEVENTTIMEKEY = :lastEventTimeKey, LASTEVENTTIME = :lastEventTime, LASTEVENTUSER = :lastEventUser, LASTEVENTCOMMENT = :lastEventComment" +
	...
	{	
		...
		long rv = GenericServiceProxy.getSqlMesTemplate()
