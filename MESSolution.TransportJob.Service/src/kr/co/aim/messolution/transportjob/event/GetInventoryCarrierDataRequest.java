...
public class GetInventoryCarrierDataRequest extends SyncHandler {
	...
	{
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("GetInventoryCarrierDataRequest", getEventUser(), getEventComment(), "", "");
