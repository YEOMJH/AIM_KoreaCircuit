...
public class GetInventoryZoneDataReply extends AsyncHandler {
	...
	{
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("GetInventoryZoneDataReply", getEventUser(), getEventComment(), "", "");
