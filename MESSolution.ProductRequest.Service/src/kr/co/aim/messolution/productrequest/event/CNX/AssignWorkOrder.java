...
public class AssignWorkOrder extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException
	{
		...
		for (Element workOrder : workOrderList)
		{
			...
			ProductRequestAssign assignData = ExtendedObjectProxy.getProductRequestAssignService().getProductRequestAssignData(productRequestName, toProductRequestName);
			...
			if (assignData == null)
			{
				...
				ExtendedObjectProxy.getProductRequestAssignService().create(eventInfo, dataInfo);
			}
		}
