...
public class ScrapShield extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ScrapShield", this.getEventUser(), this.getEventComment(), "", "");
	...
	private void updateShieldLot(List<Object[]> updateArgsList) throws CustomException
	{
		...
		sql.append(" SET LOTSTATE = ? , CARRIERNAME = ? , REASONCODETYPE = ? , REASONCODE = ? , LASTEVENTCOMMENT = ? , LASTEVENTNAME = ? , LASTEVENTUSER = ? , LASTEVENTTIME = ? , LASTEVENTTIMEKEY = ? ");
