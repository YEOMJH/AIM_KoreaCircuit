...
public class ComponentHistory extends UdfAccessor {
	...
	@CTORMTemplate(seq = "28", name="chamberUseCount", type="Column", dataType="Number", initial="", history="")
	private Number chamberUseCount;
	...
	public Number getChamberUseCount()
	{
		return chamberUseCount;
	}
	public void setChamberUseCount(Number chamberUseCount)
	{
		this.chamberUseCount = chamberUseCount;
	}
