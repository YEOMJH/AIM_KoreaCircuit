...
public class ComponentPalletInSubUnit extends AsyncHandler {
	...
	public void doWorks(Document doc) throws CustomException
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentPalletInSubUnit", getEventUser(), getEventComment(), null, null);
