...
public class ComponentOLEDMaskOutUnit extends AsyncHandler {
...
//		String maskGroupName = SMessageUtil.getBodyItemValue( doc, "MASKGROUPNAME", false );
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentOLEDMaskOutUnit", getEventUser(), getEventComment(), null, null);
