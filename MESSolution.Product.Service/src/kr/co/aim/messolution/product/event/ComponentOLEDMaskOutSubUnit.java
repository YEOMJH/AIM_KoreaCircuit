...
public class ComponentOLEDMaskOutSubUnit extends AsyncHandler {
...
//		String maskGroupName = SMessageUtil.getBodyItemValue(doc, "MASKGROUPNAME", false );
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentOLEDMaskOutSubUnit", getEventUser(), getEventComment(), null, null);
