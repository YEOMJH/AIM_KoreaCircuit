...
public class ComponentPanelInUnit extends AsyncHandler {
	...
	public void doWorks(Document doc) throws CustomException {
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentPanelInUnit", getEventUser(), getEventComment(), null, null);
