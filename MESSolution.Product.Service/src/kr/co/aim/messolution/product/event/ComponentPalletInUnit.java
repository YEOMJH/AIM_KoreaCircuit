...
public class ComponentPalletInUnit extends AsyncHandler {
	...
	public void doWorks(Document doc) throws CustomException {
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentPalletInUnit", getEventUser(), getEventComment(), null, null);
