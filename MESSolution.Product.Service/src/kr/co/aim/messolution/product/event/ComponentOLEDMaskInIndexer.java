...
public class ComponentOLEDMaskInIndexer extends AsyncHandler {
...
//		String maskGroupName = SMessageUtil.getBodyItemValue(doc, "MASKGROUPNAME", false );
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentOLEDMaskInIndexer", getEventUser(), getEventComment(), null, null);
