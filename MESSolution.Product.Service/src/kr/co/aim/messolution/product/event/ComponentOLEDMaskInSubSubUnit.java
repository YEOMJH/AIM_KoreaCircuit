...
public class ComponentOLEDMaskInSubSubUnit extends AsyncHandler {
...
//		String maskGroupName = SMessageUtil.getBodyItemValue(doc, "MASKGROUPNAME", false );
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentOLEDMaskInSubSubUnit", getEventUser(), getEventComment(), null, null);
