...
public class ComponentPanelOutUnit extends AsyncHandler {
	...
	public void doWorks(Document doc) throws CustomException {
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentPanelOutUnit", getEventUser(), getEventComment(), null, null);
