...
public class ComponentOLEDMaskLineOut extends AsyncHandler {
	...
	public void doWorks(Document doc) throws CustomException {
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentOLEDMaskLineOut", getEventUser(), getEventComment(), null, null);
