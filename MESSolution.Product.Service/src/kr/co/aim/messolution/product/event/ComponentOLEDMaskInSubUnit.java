...
public class ComponentOLEDMaskInSubUnit extends AsyncHandler {
...
//		String maskGroupName = SMessageUtil.getBodyItemValue(doc, "MASKGROUPNAME", false );
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentOLEDMaskInSubUnit", getEventUser(), getEventComment(), null, null);
