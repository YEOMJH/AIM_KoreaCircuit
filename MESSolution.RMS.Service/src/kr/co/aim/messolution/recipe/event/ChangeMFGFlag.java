...
public class ChangeMFGFlag extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException {
		...
		String MFGFlag = SMessageUtil.getBodyItemValue(doc, "MFGFlag", true);
		MESRecipeServiceProxy.getRecipeServiceUtil().verifyUserPrivilege(getEventUser(), machineName);
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("MFGFlagChange", getEventUser(), getEventComment(), null, null);
	    Recipe recipeInfo = ExtendedObjectProxy.getRecipeService().selectByKey(false, new Object[] {machineName, recipeName});
	    
	    if(recipeInfo.getMFGFlag().equals(MFGFlag))
	    {
