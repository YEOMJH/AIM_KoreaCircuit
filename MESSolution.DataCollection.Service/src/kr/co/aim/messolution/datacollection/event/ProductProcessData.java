...
public class ProductProcessData extends AsyncHandler {
		...
		throws CustomException  
	{
		...
		List<Map<String, Object>> processOperationSpecData = DataCollectionServiceUtil.getProcessOperationSpecData(productData, processOperationName, unitName);
		...
		if(processOperationSpecData.size() > 0)
		{
			...
			if(index != -1)
				...
				setEventInfo.getUdfs().put("BEFOREPROCESSOPERATION", processOperationName);
