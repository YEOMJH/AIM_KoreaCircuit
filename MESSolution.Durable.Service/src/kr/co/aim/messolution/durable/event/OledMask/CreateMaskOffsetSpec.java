...
public class CreateMaskOffsetSpec extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException {
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("CreateMaskOffsetSpec", getEventUser(), getEventComment(), "", "");
		...
		if (StringUtil.isNotEmpty(maskKind) && StringUtil.equals(maskKind, "EVA"))
		{
			for(Element MaskOffset:MaskOffsetList){
				...
				MaskOffsetSpec dataInfo = new MaskOffsetSpec();
				...
				ExtendedObjectProxy.getMaskOffsetSpecService().create(eventInfo, dataInfo);
			}
		}
		else
		{
