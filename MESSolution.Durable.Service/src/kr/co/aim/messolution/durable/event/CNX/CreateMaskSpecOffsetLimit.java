...
public class CreateMaskSpecOffsetLimit extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("CreateMaskSpecOffsetLimit", this.getEventUser(), this.getEventComment(), "", "");
