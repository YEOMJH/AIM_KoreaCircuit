...
public class AssignBasketShield extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("AssignBasketShield", this.getEventUser(), this.getEventComment(), "", "");
		...
		for (Element shield : shieldList)
		{
			...
			updateBindList.add(durableName);
