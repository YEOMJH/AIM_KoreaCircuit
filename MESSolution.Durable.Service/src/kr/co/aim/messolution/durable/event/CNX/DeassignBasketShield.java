...
public class DeassignBasketShield extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("DeassignBasketShield", this.getEventUser(), this.getEventComment(), "", "");
