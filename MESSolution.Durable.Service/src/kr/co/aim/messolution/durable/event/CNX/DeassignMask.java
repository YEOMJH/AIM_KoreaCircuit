...
public class DeassignMask extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("DeassignMask", this.getEventUser(), this.getEventComment(), "", "");
		...
		for (Element eledur : durableList)
		{
			...
			SetEventInfo setEventInfo = MESDurableServiceProxy.getDurableInfoUtil().setDeassignMaskInfo(sDurableType, "", "", "");
