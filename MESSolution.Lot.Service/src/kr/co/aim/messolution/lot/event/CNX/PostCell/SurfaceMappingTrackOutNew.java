...
public class SurfaceMappingTrackOutNew extends SyncHandler {
	...
	public Object doWorks(Document doc)throws CustomException
	{
		...
		Durable CheckTShipInfo = MESDurableServiceProxy.getDurableServiceUtil().getDurableData(sourceTrayGroupName);
		String BCRflag = CheckTShipInfo.getUdfs().get("BCRFLAG").toString();
		...
		for (Element lotData : lotList)
		{
			...
			{
			 lotDetailGrade = lotInfo.getUdfs().get("LOTDETAILGRADE").toString();
			}
