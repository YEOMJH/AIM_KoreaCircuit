...
public class ComponentTrayGroupInUnit extends AsyncHandler 
{
	private static Log log = LogFactory.getLog(ComponentTrayGroupInUnit.class);
	...
	public void doWorks(Document doc) throws CustomException {
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentTrayGroupInUnit", getEventUser(), getEventComment(), null, null);
