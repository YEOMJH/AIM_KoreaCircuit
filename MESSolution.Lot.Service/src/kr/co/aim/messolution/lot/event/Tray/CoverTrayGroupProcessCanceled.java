...
public class CoverTrayGroupProcessCanceled extends AsyncHandler 
{
	private static Log log = LogFactory.getLog(CoverTrayGroupProcessCanceled.class);
	...
	public void doWorks(Document doc) throws CustomException
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("CoverTrayGroupProcessCanceled", getEventUser(), getEventComment());
