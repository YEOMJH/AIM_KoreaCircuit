...
public class FQCVCRReadyReport  extends SyncHandler{
	...
	public Object doWorks(Document doc) throws CustomException {
		...
		{
			eventLog.info("Not exist Panel Info on Lot Table");
		}

		EventInfo eventInfo = EventInfoUtil.makeEventInfo("FQCVCRReadyReport", getEventUser(), getEventComment(), "", "");
