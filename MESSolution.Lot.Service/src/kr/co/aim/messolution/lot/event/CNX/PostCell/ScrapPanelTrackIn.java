...
public class ScrapPanelTrackIn extends SyncHandler {

	private static Log log = LogFactory.getLog(ScrapPanelTrackIn.class);
	...
	public Object doWorks(Document doc) throws CustomException
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ScrapPanelTrackIn", getEventUser(), getEventComment(), null, null);
		...
		for (Map<String, Object> lotData : lotList)
		{
			...
			if (!StringUtils.equals(detailOperationType, "ScrapPack"))
