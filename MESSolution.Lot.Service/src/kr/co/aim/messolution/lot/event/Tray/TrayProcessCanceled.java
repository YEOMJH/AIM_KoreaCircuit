...
public class TrayProcessCanceled extends AsyncHandler {

	private static Log log = LogFactory.getLog(TrayProcessCanceled.class);
	...
	public void doWorks(Document doc) throws CustomException
	{
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("TrayProcessCanceled", getEventUser(), getEventComment());
