...
public class ComponentTrayInUnit extends AsyncHandler 
{
	private static Log log = LogFactory.getLog(ComponentTrayInUnit.class);
	...
	public void doWorks(Document doc) throws CustomException {
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentTrayInUnit", getEventUser(), getEventComment(), null, null);
