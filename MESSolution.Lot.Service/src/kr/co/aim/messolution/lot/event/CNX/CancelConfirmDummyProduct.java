...
public class CancelConfirmDummyProduct extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException {
		...
		for(Element lot:lotList){
			...
			setEventInfo.getUdfs().put("MERGEABLEFLAG", "");
			
			LotServiceProxy.getLotService().setEvent(lotData.getKey(), eventInfo, setEventInfo);
	
			MESLotServiceProxy.getLotServiceImpl().updateLotData("MERGEABLEFLAG", "", lotName);
