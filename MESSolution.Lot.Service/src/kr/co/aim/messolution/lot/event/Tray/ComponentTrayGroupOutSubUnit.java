...
public class ComponentTrayGroupOutSubUnit extends AsyncHandler 
{
	private static Log log = LogFactory.getLog(ComponentTrayGroupOutSubUnit.class);
	...
	public void doWorks(Document doc) throws CustomException {
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentTrayGroupOutSubUnit", getEventUser(), getEventComment(), null, null);
