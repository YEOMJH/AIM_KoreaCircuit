...
public class DemoPackingUnShip extends SyncHandler {
	private static Log log = LogFactory.getLog(DemoPackingUnShip.class);
	@Override
	public Object doWorks(Document doc) throws CustomException {
		...
		for (Element innerBox : innerBoxList)
		{
			...
			{
			  productRequestName =  result.get(i).get("PRODUCTREQUESTNAME").toString();
	...
	public boolean checkDemonInner(String InnerBoxName)
	{
		...
		StringBuilder sql = new StringBuilder();
		sql.append("SELECT *");
		sql.append("  FROM MES_MODIF_SHIP@OADBLINK.V3FAB.COM ");//MES_MODIF_SHIP@OADBLINK.V3FAB.COM
	...
	public boolean checkDemonSHT(String LotName)
	{
		...
		StringBuilder sql = new StringBuilder();
		sql.append("SELECT *");
		sql.append("  FROM MES_MODIF_SHIP@OADBLINK.V3FAB.COM ");
	...
	public void deleteDemonSHT(List<Object[]> deleteArgListSHT) throws CustomException
	{
		...
		{
			StringBuilder sql = new StringBuilder();
			sql.append("DELETE FROM MES_MODIF_SHIP@OADBLINK.V3FAB.COM ");
