...
public class PostCellTrayGroupChangeGrade extends SyncHandler {

	private static Log log = LogFactory.getLog(PostCellTrayGroupChangeGrade.class);
		...
		throws CustomException
	{
		...
		//EventInfo
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("TrayGroupChangeGrade", getEventUser(), getEventComment(), null, null);
		...
		for (Element lotData : lotList)
		{
			...
			//lot.setLotGrade(lotDetailGrade);
