...
public class ComponentTrayInSubUnit extends AsyncHandler 
{
	private static Log log = LogFactory.getLog(ComponentTrayInSubUnit.class);
	...
	public void doWorks(Document doc) throws CustomException {
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentTrayInSubUnit", getEventUser(), getEventComment(), null, null);
