...
public class DeleteMVIJNDDefectCode extends SyncHandler {
	...
	public Object doWorks(Document doc) throws CustomException
	{
		...
		for (Element defect : defectCodeList)
		{
			...
			ExtendedObjectProxy.getMVIJNDDefectCodeService().deleteMVIJNDDefectCode(eventInfo, productSpecName, defectCode, superDefectCode, pattern, jndName, panelGrade);
		}
