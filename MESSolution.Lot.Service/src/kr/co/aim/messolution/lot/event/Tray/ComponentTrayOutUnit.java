...
public class ComponentTrayOutUnit extends AsyncHandler 
{
	private static Log log = LogFactory.getLog(ComponentTrayOutUnit.class);
	...
	public void doWorks(Document doc) throws CustomException {
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentTrayOutUnit", getEventUser(), getEventComment(), null, null);
		eventInfo.setEventTimeKey(TimeUtils.getCurrentEventTimeKey());

		List<ComponentHistory> updateList = new ArrayList<>();

		for (Map panelInfo : resultList)
		{
