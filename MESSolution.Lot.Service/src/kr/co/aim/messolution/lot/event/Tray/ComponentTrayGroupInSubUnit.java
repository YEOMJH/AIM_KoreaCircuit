...
public class ComponentTrayGroupInSubUnit extends AsyncHandler 
{
	private static Log log = LogFactory.getLog(ComponentTrayGroupInSubUnit.class);
	...
	public void doWorks(Document doc) throws CustomException {
		...
		EventInfo eventInfo = EventInfoUtil.makeEventInfo("ComponentTrayGroupInSubUnit", getEventUser(), getEventComment(), null, null);
